...
class CustomeHttpRequest {
  static Future<NewsModel> fetchHomeData(int pageNo, String sortBy) async {
    ...
    try {
      String url =
          "https://newsapi.org/v2/everything?q=football&sortBy=$sortBy&pageSize=20&page=$pageNo&apiKey=dae4eb4267724b77b9831c0f448decaa";
  ...
  static Future<NewsModel> fetchSearchData(String query) async {
    ...
    try {
      String url =
          "https://newsapi.org/v2/everything?q=$query&pageSize10&apiKey=dae4eb4267724b77b9831c0f448decaa";
